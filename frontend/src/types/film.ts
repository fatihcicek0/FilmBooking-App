...
interface GET_RESERVATİONS_START{
    type:"GET_RESERVATİONS_START"
}
interface GET_RESERVATİONS_SUCCESS{
    type:"GET_RESERVATİONS_SUCCESS";
    payload:Reservation[];
}
interface GET_RESERVATİONS_ERROR{
    type:"GET_RESERVATİONS_ERROR"
}
...
| GET_RESERVATİONS_START | GET_RESERVATİONS_SUCCESS | GET_RESERVATİONS_ERROR;
